...
# -divide_by 2 \
# -source [get_port {emu:emu|Atari7800:main|maria:maria_inst|timing_ctrl:timing_ctrl_inst|sysclk}] \
# -name clkdiv \
#[get_registers {emu:emu|Atari7800:main|maria:maria_inst|timing_ctrl:timing_ctrl_inst|tia_clk}]

#create_clock -name FAST_CLK -period 10.000 [get_registers {emu:emu|Atari7800:main|maria:maria_inst|timing_ctrl:timing_ctrl_inst|fast_clk}]
#create_clock -name RDY_CLK -period 10.000 [get_registers {emu:emu|Atari7800:main|cpu_wrapper:cpu_inst|rdy_in}]
#create_clock -name TIA_CLK -period 10.000 [get_registers {emu:emu|Atari7800:main|maria:maria_inst|timing_ctrl:timing_ctrl_inst|tia_clk}]
#create_clock -name CLK_30 -period 10.000 [get_registers {emu:emu|Atari7800:main|TIA:tia_inst|clk_30}]
